...
/**
 * Movies page error boundary
 *
 * Catches and displays errors that occur during rendering of the movies page.
      ...
      <div className="text-center space-y-6 max-w-md">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            We couldn&apos;t load the movies page. This might be a temporary issue.
          </p>
        </div>
