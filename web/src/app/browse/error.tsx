 ...
 *
 * Catches and displays errors that occur during rendering of the browse page.
      ...
      <div className="text-center space-y-6 max-w-md">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            We couldn&apos;t load the browse page. Please try again or use search to find what you&apos;re looking for.
          </p>
        </div>
